...
const Footer = () => {
  return (
    <div className='border-t p-2 text-center'>
      <div className='logo'>
         <h1 className='text-blue-400 text-xl font-[900] my-3 w-40 m-auto  bg-white  px-2 rounded-xl flex'>Book <Image width={30} height={10} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIw5fZnR-DK3elMUUx0mdigA42aRQIZvlompLRDhqEU5asPEcTUCWk&usqp=CAE&s"
            /> Movie</h1>
      </div>
      <p className='text-white text-md m-3'>Copyright 2024 © Bigtree Entertainment Pvt. Ltd. All Rights Reserved.</p>
      <div className='SVG flex justify-center gap-10 items-center py-3 '>
