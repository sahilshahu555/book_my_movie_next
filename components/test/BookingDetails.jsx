...
const BookingDetails = ({ bookings }) => {
  ...
  return (
    <div className='flex flex-col justify-start w-full p-2 rounded-xl gap-2 items-center  '>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5 bg-blue-300 w-full rounded-xl p-2 min-h-24'>
        {bookings.length<=0 ?(
          <h2 className="text-center mb-5 font-bold text-blue-400  text-lg my-2">Please Book Movie Tickets</h2>
