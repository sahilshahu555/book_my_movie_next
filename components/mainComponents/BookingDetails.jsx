...
const BookingDetails = ({ bookings }) => {
  ...
  return (
    <div id='Details' className='flex flex-col justify-start w-full p-2 mb-10 rounded-xl gap-2 items-center  '>
       <h2 className="text-center mb-5 font-bold text-blue-400 text-2xl my-2">Booking Details</h2>
      <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10 md:gap-10 w-full  rounded-xl p-5 min-h-24'>
        {bookings.length<=0 ?(
